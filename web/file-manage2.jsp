					...
					<div class="container">
						...
						<div class="card shadow mb-5">
							...
							<div class="card o-hidden border-0 shadow-lg my-5 cqmb-back">
								<div class="cqmb-top">
									<div class="card-body">
										<div class="bg-primary text-white p-3 rotate-15 d-inline-block my-5 mb-5 offset-sm-5" style="margin-top: 10em; background: pink;display:block">很抱歉，您无权进行文件操作</div>
									</div>
								</div>
							</div>
						</div>
